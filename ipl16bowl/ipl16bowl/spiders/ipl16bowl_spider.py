...
from ipl16bowl.items import Ipl16bowlItem


class Ipl16bowlSpider(Spider):
    name = 'ipl16bowl_spider'
    allowed_urls = ['https://www.espncricinfo.com/']
    start_urls = ['https://stats.espncricinfo.com/ci/engine/records/averages/bowling.html?id=11001;type=tournament']
