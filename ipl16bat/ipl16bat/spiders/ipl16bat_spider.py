...
from ipl16bat.items import Ipl16batItem


class Ipl16batSpider(Spider):
    name = 'ipl16bat_spider'
    allowed_urls = ['https://www.espncricinfo.com/']
    start_urls = ['https://stats.espncricinfo.com/ci/engine/records/averages/batting.html?id=11001;type=tournament']
